...
function frontier_can_edit($tmp_post)
	...
	if ( !fp_check_post_type($tmp_post->post_type) )
		{
		$tmp_can_do = false;
		$fps_access_check_msg = $fps_access_check_msg.__("You are not allowed to edit", "frontier-post").": ".fp_get_posttype_label($tmp_post_type)."<br>";
		}
...
function frontier_can_delete($tmp_post)
	...
	if ( !fp_check_post_type($tmp_post->post_type) )
		{
		$tmp_can_do = false;
		$fps_access_check_msg = $fps_access_check_msg.__("You are not allowed to delete: ", "frontier-post").__($tmp_post->post_type)."<br>";
		}
