				...
				<td>
					<?php
						...
						if (frontier_can_delete($post) == true)
							{
								?>
									<a href="<?php echo $frontier_permalink; ?><?php echo $concat;?>task=delete&postid=<?php echo $post->ID."&frontier_return_page_id=".$tmp_page_id;?>" ><?php _e("Delete", "frontier-post") ?></a>
								<?php
							}
