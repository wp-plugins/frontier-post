...
// define constants
define('FRONTIER_POST_VERSION', "2.8.0"); 
...
//add_action("init","frontier_posting_form_submit", 1); 
//add_action("init","frontier_execute_delete_post");  
...
function frontier_post_add_link($tmp_cat_id = null) 
	{
	$url = '';
